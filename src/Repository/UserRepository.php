...
class UserRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    public function paginateMember(int $Page, int $MaxResult): PaginationInterface {

        return $this->Paginator->paginate(
            target: $this->createQueryBuilder('u'), 
            page: $Page, 
            limit: $MaxResult
        );
    }

    /*public function paginateMember(int $Page, int $MaxResult): Paginator {
