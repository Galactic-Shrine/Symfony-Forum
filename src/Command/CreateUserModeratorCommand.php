 ...
 * et modérateur, définit le statut de présence sur hors ligne, définit l'ima-
...
class CreateUserAdminCommand extends UserConfigureCommand {
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int {
        ...
        $user->setRoles(['ROLE_USER', 'ROLE_MODERATOR']); // set the user and moderator role
        ...
        $output->writeln('User moderator created successfully.');
